...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(520, 250, 251, 171))
        ...
        self.objectText = QtWidgets.QTextEdit(self.centralwidget)
        self.objectText.setGeometry(QtCore.QRect(530, 160, 231, 61))
        self.objectText.setObjectName("objectText")
