...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.channelEdit.setGeometry(QtCore.QRect(530, 150, 231, 31))
        font = QtGui.QFont()
        ...
        self.disableButton.setGeometry(QtCore.QRect(640, 220, 130, 28))
        self.disableButton.setObjectName("disableButton")
        self.enableButton = QtWidgets.QPushButton(self.centralwidget)
        self.enableButton.setGeometry(QtCore.QRect(510, 220, 130, 28))
        self.enableButton.setObjectName("enableButton")
        self.beauty_on_btn = QtWidgets.QPushButton(self.centralwidget)
        self.beauty_on_btn.setGeometry(QtCore.QRect(540, 20, 90, 30))
        self.beauty_on_btn.setObjectName("beauty_on_btn")
        self.beauty_off_btn = QtWidgets.QPushButton(self.centralwidget)
        self.beauty_off_btn.setGeometry(QtCore.QRect(640, 20, 90, 30))
        self.beauty_off_btn.setObjectName("beauty_off_btn")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(530, 70, 111, 16))
        font = QtGui.QFont()
        font.setFamily("微软雅黑 Light")
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.appIdEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.appIdEdit.setGeometry(QtCore.QRect(530, 90, 231, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑 Light")
        self.appIdEdit.setFont(font)
        self.appIdEdit.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.ArrowCursor))
